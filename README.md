...
### 5. Примеры машинного обучения с использованием синтетических данных    
__Описание__  
Данный проект содержит практические реализации базовых алгоритмов машинного обучения с использованием синтетических наборов данных:
*   __Модель линейной регрессии__ для предсказания непрерывных целевых переменных.
*   __Алгоритм k ближайших соседей (KNN)__ для задач классификации.

__Используемые инструменты__    
Python, scikit-learn, numpy, matplotlib, pandas    
[Задания](./ML_methods/LinReg_kNN.ipynb)
    
### 6. Прогноз погоды на 5 дней с интервалом 3 часа для Санкт-Петербурга.   
__Описание__   
