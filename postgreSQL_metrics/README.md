...
order by cohort;
```
#### Выводы по сегментации пользователей по количеству кликов
...
Метрика retention_percent показывает, что необходимо обратить внимание на первые 1-2 месяца после регистрации для удержания пользователей и повышения их активности.
...
# Общие выводы
Таким образом, данная система аналитики позволила получить:
